...
import com.example.e_learningnavi.question.QuestionActivity;

import java.util.ArrayList;

public class ToogleButtonGroupLayout extends TableLayout {
    private RadioButton mActiveRadioButton;
    public ToogleButtonGroupLayout(Context context) {
        super(context);
    }

    public ToogleButtonGroupLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
